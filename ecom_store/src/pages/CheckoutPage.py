...
from ecom_store.src.pages.locators.CheckoutPageLocators import CheckoutPageLocators
# from ecom_store.src.utilities.genericUtilities import generate_random_email_and_password
